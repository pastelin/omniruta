...
public class HEADFailStaffPayoutService {
    ...
    public HEADStaffPayoutResponse execute(Long payoutId, String note) {
        ...
        if (payout.getStatus() != HEADStaffPayoutStatus.APPROVED
            ...
            throw new HEADBadRequestException("El payout no se puede marcar como fallido en estado " + payout.getStatus());
        }
        ...
        payout.setNote(note != null ? note.trim() : "Pago fallido");
